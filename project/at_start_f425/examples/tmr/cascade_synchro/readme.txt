/**
  ...
  */
   ...
   *  the timxclk is fixed to 96 mhz, the tmr2 counter clock is 96 mhz.

    the primary timer tmr1 is running at tmr1 frequency :
    tim1 frequency = (tmr1 counter clock)/ (tmr1 period + 1) = 806 khz 
    and the duty cycle = tmr1_c1dt/(tmr1_pr + 1) = 25%.

    the tmr3 is running at:
    (tmr3 frequency)/ (tmr3 period + 1) = 66.6 khz and a duty cycle equal 
    to tmr3_c1dt/(tmr3_pr + 1) = 25%

    the tmr15 is running at:
    (tmr15 frequency)/ (tmr15 period + 1) = 5.55 khz and a duty cycle equal 

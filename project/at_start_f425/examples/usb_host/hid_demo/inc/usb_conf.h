...
#define OTG_PIN_POWER_SWITCH_GPIO        GPIOD
#define OTG_PIN_POWER_SWITCH_CLOCK       CRM_GPIOD_PERIPH_CLOCK
#define OTG_PIN_POWER_SWITCH             GPIO_PINS_2
